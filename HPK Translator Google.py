...
app.title("HPK Translator (Google Translate)")
...
# Custom colors
TRANSLATE_BUTTON_COLOR = "#4285F4"
TRANSLATE_BUTTON_HOVER_COLOR = "#3367D6"
RESET_BUTTON_COLOR = "#DB4437"
RESET_BUTTON_HOVER_COLOR = "#B31412"
INPUT_FRAME_COLOR = "#424242"
ARABIC_SCROLL_COLOR = "#1d1e1e"
...
def create_language_section(label_text, lang_code, is_input=False):
    ...
    if lang_code == 'ar':
        textbox.configure(font=("Calibri", 12))
        textbox.configure(scrollbar_button_color=ARABIC_SCROLL_COLOR)
...
for label, code in languages:
    textbox, char_count_label = create_language_section(label, code)
